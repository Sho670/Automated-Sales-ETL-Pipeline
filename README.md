...
# <p align="center" style="font-size: 55px;">🤖 <b>Automation of Sales Ecosystem</b></p>
...
## <p style="font-size: 35px;">🚀🚀  Purpose of Project</p>
...
## <p style="font-size: 35px;">📌  End-to-End Flow </p>
...
## <p style="font-size: 35px;">⚡⚡⚡ Orchestration and Automation </p>
...
## <p style="font-size: 35px;">⚙️ Core Technologies Used: </p>
...
**✈️ Apache Airflow** for scheduling, dependency management, and retries.
...
## <p style="font-size: 35px;"> 📂 Dataset </p>
...
## <p style="font-size: 35px;"> 🎯 Business value </p>
...
## <p style="font-size: 35px;">🏢🏛️Architecture of the Project: </p>
